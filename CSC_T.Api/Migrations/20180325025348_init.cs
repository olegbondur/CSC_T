...
namespace CSC_T.Api.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryBusiness", x => new { x.CountryId, x.BusinessId });
                    table.ForeignKey(
                        name: "FK_CountryBusiness_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CountryBusiness_Countries_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryBusiness_BusinessId",
                table: "CountryBusiness",
                column: "BusinessId");
